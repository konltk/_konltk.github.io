...
![fork](http://www.konltk.org/static/open-source-contribution/1.png)
...
![pull request](http://www.konltk.org/static/open-source-contribution/2.png)

다시 중간에 `Create pull request` 버튼을 눌러 request를 생성한다.

![pull request](http://www.konltk.org/static/open-source-contribution/3.png)
...
![pull request](http://www.konltk.org/static/open-source-contribution/4.png)
